...
static const char qt_meta_stringdata_contract[] = {
    "contract\0\0sendsignal()\0returnFun()\0"
};
...
const QMetaObjectExtraData contract::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject contract::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_contract,
      qt_meta_data_contract, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &contract::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_contract))
        return static_cast<void*>(const_cast< contract*>(this));
